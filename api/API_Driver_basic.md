...
_Never_ directly free **pdev** after calling this function, even if it returned an error! Always use [`platform_device_put()`](https://www-kernel-org.translate.goog/doc/html/latest/driver-api/infrastructure.html?_x_tr_sl=auto&_x_tr_tl=zh-CN&_x_tr_hl=zh-CN&_x_tr_pto=wapp#c.platform_device_put) to give up the reference initialised in this function instead.
...
- bool `dma_can_mmap`(struct [device](https://www-kernel-org.translate.goog/doc/html/latest/driver-api/infrastructure.html?_x_tr_sl=auto&_x_tr_tl=zh-CN&_x_tr_hl=zh-CN&_x_tr_pto=wapp#c.device) **dev*)
...
Returns `true` if **dev** supports dma_mmap_coherent() and [`dma_mmap_attrs()`](https://www-kernel-org.translate.goog/doc/html/latest/driver-api/infrastructure.html?_x_tr_sl=auto&_x_tr_tl=zh-CN&_x_tr_hl=zh-CN&_x_tr_pto=wapp#c.dma_mmap_attrs) to map DMA allocations to userspace.
...
- `struct device *dev`
  ...
  valid [`struct device`](https://www-kernel-org.translate.goog/doc/html/latest/driver-api/infrastructure.html?_x_tr_sl=auto&_x_tr_tl=zh-CN&_x_tr_hl=zh-CN&_x_tr_pto=wapp#c.device) pointer, or NULL for ISA and EISA-like devices
...
- `struct pnp_protocol *protocol`
  ...
  pointer to the corresponding pnp_protocol structureEx protocols: ISAPNP, PNPBIOS, etc
